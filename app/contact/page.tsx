      ...
      <section className="relative bg-gradient-to-br from-brand-warm-brown to-brand-burgundy text-white py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl opacity-90 max-w-2xl mx-auto">
            Located in the heart of Woodland at Purity Plaza. We're open daily
            at 7:00 AM and ready to serve you delicious food with warm
            hospitality.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              {/* Embedded Google Map */}
              <div className="bg-brand-cream rounded-xl overflow-hidden shadow-lg">
                <div className="aspect-video w-full">
                  <iframe
                    ...
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3126.8567929999998!2d-121.7719!3d38.662!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80862d85d5a5a5a5%3A0x5a5a5a5a5a5a5a5a!2s9%20Main%20St%20STE%20107%2C%20Woodland%2C%20CA%2095695!5e0!3m2!1sen!2sus!4v1643834567890"
                    title="Rafael's Family Restaurant Location Map"
                  />
                </div>
              ...
              {/* Location Features */}
              <div className="mt-8 bg-brand-warm-white text-brand-burgundy rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-8 shadow-lg">
              ...
              <p className="text-gray-600">
                Enjoy a comfortable meal in our warm, family-friendly dining
                room. Perfect for breakfast meetings, family dinners, or a quick
                lunch.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg">
              ...
              <p className="text-gray-600">
                Call ahead for quick pickup. All our delicious meals are
                carefully packaged to maintain quality and temperature.
              </p>
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-700 mb-8 max-w-2xl mx-auto">
            Great food doesn't have to be expensive. Most of our meals range
            from $10–$20 per person, making Rafael's perfect for families,
            students, and anyone looking for quality food at fair prices.
          </p>
          ...
          <div className="bg-brand-warm-white rounded-xl p-8 max-w-2xl mx-auto">
            ...
            <div className="text-lg text-gray-600 mb-4">
              Average meal price including drink
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-brand-red bg-opacity-20 rounded-2xl p-8 max-w-2xl mx-auto">
            <blockquote className="text-xl italic mb-4">
              "The perfect neighborhood restaurant! Great food, friendly
              service, and prices that won't break the bank. Rafael's has become
              our family's regular spot."
            </blockquote>
      ...
      <section className="py-16 bg-brand-warm-brown text-white text-center">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl mb-8 opacity-90">
            Whether you're craving a hearty breakfast, satisfying lunch, or
            comfortable dinner, Rafael's Family Restaurant is ready to welcome
            you with delicious food and warm hospitality.
          </p>
